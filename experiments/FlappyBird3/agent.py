...
class Agent():
    ...
    def __init__(self, hyperparameter_set):
        with open("C:/Users/jeongchan/iCloudDrive/iCloud~md~obsidian/obsidian/SMU/2024-2/강화학습/project/FlappyBird/FlappyBird3/hyperparameters.yml", 'r') as file:
            try:
                all_hyperparameter_sets = yaml.safe_load(file)
                hyperparameters = all_hyperparameter_sets[hyperparameter_set]
            except UnicodeDecodeError:
                file.close()
                file = open("C:/Users/jeongchan/iCloudDrive/iCloud~md~obsidian/obsidian/SMU/2024-2/강화학습/project/FlappyBird/FlappyBird3/hyperparameters.yml", 'r', encoding='utf-8')
                all_hyperparameter_sets = yaml.safe_load(file)
                hyperparameters = all_hyperparameter_sets[hyperparameter_set]
